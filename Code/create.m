...
% X - input values
% numWeights - number of weights (hidden vectors) to be used for the CMAC algorithm
% numCell - number of Association cells to be linked with each input vector
% (this is used to dicretize the input space as it is a real space with infinite values)
